...
pub fn ping(addr: IpAddr, timeout: Option<Duration>, ttl: Option<u32>, ident: Option<u16>, seq_cnt: Option<u16>, payload: Option<&Token>) -> std::result::Result<(u16, u16), anyhow::Error> {
    ...
    let reply = if dest.is_ipv4() {
        ...
        return Ok((reply.ident, reply.seq_cnt));
        // {
        //     Ok(reply) => reply,
